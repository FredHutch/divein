...
print "<form enctype='multipart/form-data' action=\"/cgi-bin/diver/raxml.cgi\" name=grpForm method=post onsubmit=\"setAllTrue('mulselect'); return CheckOutgroup(this.DiverSeqName, this.OutgrpSeqName, 'mulselect');\">";
...
print "<input type=hidden name='heteromodel' value=$heteromodel>";
