...
my ($id, $seqFileName, $seqType, $bootstrap, $subRateCat, $gamma, $diver, @divergence, $size_flag, $uploadDir);
...
my @parameterArray;
push @parameterArray, $id, $seqFileName, $seqType, $datatype, $bootstrap, $subModel, $subRateCat, $gamma, $email, $diver, $uploadDir, $remote_addr, $divergences, $docsRoot, $program;
...
if ($pid == 0) {
	...
	exec("perl", "fasttree.pl", @parameterArray);
	exit(0);
}
