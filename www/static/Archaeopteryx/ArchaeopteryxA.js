...
function openWin( dataurl, codebase, configfile ) {
...
//  aptx_window.document.write( " CODEBASE=\"http://indra.mullins.microbiol.washington.edu/DIVEIN/Archaeopteryx\"" );
  ...
  aptx_window.document.writeln( "<PARAM NAME=\"config_file\" VALUE=\"" + codebase + "/" + configfile + "\">" );
